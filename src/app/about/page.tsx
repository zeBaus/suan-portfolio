  ...
  return (
    <main className="min-h-screen py-16">
      <Container>
        ...
        <section className="mt-12 grid max-w-5xl gap-6 md:grid-cols-[220px_1fr]">
            {/* Profile */}
            <Card>
            <CardHeader>
            ...
            <CardContent>
                ...
                {/* Placeholder avatar (swap later with an <Image /> once you add a real photo) */}
            ...
            <CardContent>
                ...
                <div>
                    ...
                    <li>
                        <span className="text-white/90 font-medium">Understand:</span>{" "}
                        product flows, knowledge base, and key code paths.
                    </li>
                    <li>
                        <span className="text-white/90 font-medium">Stabilize:</span>{" "}
                        fix high-signal bugs and reduce friction points.
                    </li>
                    <li>
                        <span className="text-white/90 font-medium">Improve:</span>{" "}
        ...
        <section className="mt-12 max-w-5xl">
            ...
            <CardContent>
                ...
                <li>Replace placeholder avatar with a real photo (Next/Image).</li>
                <li>Add a short timeline section (roles + milestones).</li>
                <li>Add tasteful page transitions (Framer Motion) without hurting performance.</li>
                </ul>
            </CardContent>
            </Card>
        </section>
