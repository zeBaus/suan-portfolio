...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-white/20 bg-black/10 text-white shadow-sm transition will-change-transform hover:-translate-y-0.5 hover:bg-white/[0.06] hover:border-white/30",
      className
    )}
    {...props}
  />
